...
<style>
  :root {
    ...
    --white:#f5f5f5;
    --accent:#cc2255; --accent-raw:#660033; --accent-hover:#e23a6a;
    --gold-start:#b8960c; --gold-mid:#d4af6a; --gold-end:#f0e8d0;
    --muted:rgba(245,245,245,0.55);
    --dim:rgba(245,245,245,0.38);
    --ghost:rgba(245,245,245,0.20);
    --surface-1:rgba(245,245,245,0.035);
    --surface-2:rgba(245,245,245,0.06);
    --border-subtle:rgba(245,245,245,0.08);
    --border-mid:rgba(245,245,245,0.14);
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .backdrop {
    ...
    background:
      radial-gradient(120% 80% at 50% -10%, rgba(204,34,85,0.16), transparent 55%),
      radial-gradient(90% 60% at 50% 120%, rgba(184,150,12,0.07), transparent 60%),
      var(--black);
  }
  .grain {
  ...
  .save:hover { background:var(--accent-hover); transform:translateY(-2px); box-shadow:0 12px 34px rgba(204,34,85,0.36); }
  ...
  .footer .tag b { font-family:var(--font-sans); font-style:normal; font-weight:800; color:rgba(245,245,245,0.78); text-transform:uppercase; font-size:12px; letter-spacing:0.04em; }
  .footer .url {
  ...
  .toast {
    ...
    z-index:10000;
    background:var(--secondary); border:1px solid var(--border-mid);
    color:var(--white); font-size:12px; font-weight:600; letter-spacing:0.04em;
    padding:12px 18px; border-radius:100px;
    box-shadow:0 12px 40px rgba(0,0,0,0.6);
    opacity:0; pointer-events:none; transition:opacity 0.3s ease, transform 0.3s var(--ease-spring);
...
<body>
  ...
  <main class="card" aria-label="Contact card for Rafhin Mir">
    <span class="eyebrow">digital contact card</span>

    <img class="logo" src="/assets/logos/RV-PFP-Burgundy.png" alt="Rafhin Visuals" />
    ...
    <button class="save" id="saveBtn" type="button">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/><line x1="19" y1="6" x2="19" y2="10"/><line x1="21" y1="8" x2="17" y2="8"/></svg>
      Save contact
    </button>
    ...
    <div class="footer">
      <div class="tag"><b>Built with intent.</b> Made to last.</div>
      <div class="url">rafhin.com</div>
    </div>
  </main>
